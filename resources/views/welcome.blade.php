<x-home.app>
   ...
   {{-- component modal konsultasi --}}
        <dialog id="chat" class="overflow-hidden">
            ...
            <dotlottie-player src="https://lottie.host/c22a575e-db19-4db8-8519-421237b8098c/l6FtG2ZWUJ.json" background="transparent" speed="1" style="width: auto;" loop autoplay></dotlottie-player>
            <div class="contact flex flex-col gap-4">
                <button onclick="window.location.href='https://wa.link/a8nsc4'" class="border-2 border-black w-full h-10 rounded-2xl hover:scale-105 transition-all hover:bg-gray-200">
                    Konsultasi Pembayaran
                </button>
                <button onclick="window.location.href='https://wa.link/jbqa41'" class="border-2 border-black w-full h-10 rounded-2xl hover:scale-105 transition-all hover:bg-gray-200">
                    Konsultasi Perlombaan
                </button>
                <button onclick="window.location.href='https://wa.link/83qwpk'" class="border-2 border-black w-full h-10 rounded-2xl hover:scale-105 transition-all hover:bg-gray-200">
        ...
        <div class="mx-auto">
            <div class="banner w-full h-96 relative">
                <div class="text absolute inset-0 m-5 flex flex-col lg:items-center justify-center lg:-bottom-10 z-10">
                    <img width="500" class="lg:block  hidden" src="{{asset('assets/logo-src.png')}}" alt="">
               ...
               <!--<button onclick="window.location.href='#competition'" class="relative -bottom-20 lg:-bottom-10 text-black  lg:left-0 bg-yellow-400 border-black border-2 font-bold  hover:text-black border-2 px-10  py-2 hover:scale-105 transition-all shadow-md ">SEMUA KOMPETISI</button>-->
                ...
                <img src="{{asset('assets/banner2.jpg')}}" alt="banner"  class="banner-img w-full h-full relative top-15 object-center  object-cover lg:block hidden ">
                <img src="{{asset('assets/Poster_Cover.jpg')}}" alt="banner"  class="banner-img w-full h-full  object-cover lg:hidden block ">
            </div>
        </div>
    </div>
    
    <div class="flex flex-wrap gap-1">
    <!--    <div class="timeline container py-2 mt-3 ">-->
    <!--    <img src="{{asset('assets/timeline.gif')}}" class="w-full rounded-lg" alt="">-->
    <!--</div>-->
          ...
          <div class="mb-12 lg:max-w-lg lg:pr-5 lg:mb-0">
            <div class="max-w-xl mb-6">
              ...
              <p class="text-base text-gray-700 md:text-lg">
                "SRC merupakan kompetisi tahunan yang luar biasa. Karena kegiatan ini bukan hanya tentang teknologi dan robot, tetapi juga tentang kolaborasi, inovasi dan semangat untuk belajar. Selain itu hadiah menarik dan penghargaan yang menanti untuk para pemenang…."
              </p>
            </div>
            ...
            <div class="flex">
              <a  aria-label="Play Song" class="mr-3">
                    <div class="flex items-center justify-center w-10 h-10 text-white transition duration-300 transform rounded-full shadow-md bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 hover:scale-110">
                     <img class="rounded-full w-full h-full object-cover" src="https://upload.wikimedia.org/wikipedia/commons/f/f5/Kusmana_Hartadji.jpg" alt="">
                     </div>
    ...
    <div class=" relative w-full mb-8  " style=" overflow:hidden ">
       <div  id="competition" class="perlombaan container lg:p-[60px] p-4 lg:max-w-screen-xl">
        <div  class="lg:text-[24px] text-[20px] relative mb-2 leading-normal font-extrabold tracking-tight text-gray-900">
            ⭐Perlombaan Robotik
        </div>
                ...
                <div class="wrapper hover:scale-105 transition-all  antialiased text-gray-900">
                    <div>
                     <a href="{{url('detail/'.$datas->id)}}" style="text-decoration: none" >
                        <img src="{{$datas->image}}" alt=" random imgee" class="w-full object-cover object-center rounded-lg shadow-md">
                            </a>
                    <div class="relative px-4 -mt-16  ">
                    <div class="bg-white p-6 rounded-lg shadow-lg">
                        <div class="flex items-baseline">
                            @if ($datas->category->name == "online" )
                        <span class="bg-yellow-200 text-teal-800 text-xs px-2 inline-block rounded-full  uppercase font-semibold tracking-wide">
                           {{$datas->category->name}}
                        </span>
                        @else
                        ...
                        <h4 class="mt-1 text-xl font-semibold uppercase leading-tight truncate">{{$datas->name}}</h4>

                    <div class="mt-1">
                        <span class="text-gray-600 text-sm">   Biaya.</span> {{ number_format($datas->price, 2, ',', '.') }}

                    </div>
                    <div class="mt-4">
                        <!--<span class="text-teal-600 text-md font-semibold">{{$datas->max_people}} max people </span>-->
                                           <span class="text-sm text-gray-600">Masa Registrasi sampai <span class="font-bold">{{$datas->deadline_reg}}</span> </span>
                            <span class="relative">
                            <button onclick="window.location.href='{{$datas->juknis_lomba}}'" class="bg-blue-500 px-2 rounded text-white hover:bg-blue-800">Juknis Lomba</button>
                        </span>
                    </div>
                    </div>
                    </div>
        ...
        <div class="bg-blue-800 rounded-2xl w-full  flex flex-wrap justify-center items-center">
            ...
            <div class="grup lg:px-0 px-5">
                ...
                <div class="button relative mt-2 py-4  lg:block flex justify-center">
                    <button class="text-black rounded-2xl font-bold gap-2  bg-white px-5 py-2 hover:scale-105 transition-all flex justify-center items-center lg:text-[17px] text-[12px]  " onclick="window.chat.showModal()">
                        <img class="w-6" src="https://roboguru-forum-cdn.ruangguru.com/image/ce8b0c17-4e1e-49f9-abf2-ba6c7eb3d192.png" alt="icon-chat">
       ...
       <div  id="directive" class="teknis relative py-5 container lg:p-[60px] p-4 lg:max-w-screen-xl ">
            ...
            Petunjuk Teknis ⭐
                ...
                <p class="lg:w-[700px]">File Petunjuk Teknis yang terlampir adalah untuk semua kategori. Silakan <span class="text-black font-bold">download Petunjuk Teknis</span> dibawah untuk pertanyaan dapat menghubungi Panitia</p>
       ...
       <div class="bg-gray-100 p-1 ">
            <div class="container  my-5 lg:max-w-screen-xl"  id="faq" data-aos="fade-up">
                ...
                <div class="row row-cols-1 row-cols-sm-2">
                    ...
                    <div class="col my-3 my-sm-0 h-[40em] transition-all animate-none overflow-auto " data-aos-duration="1500" data-aos="fade-left">
...
<script type="module">
  ...
  keenSliderNextDesktop.addEventListener('click', () => keenSlider.next())
    ...
    <div id="galeri" class="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:items-center lg:gap-16 container lg:p-[60px] p-4 lg:max-w-screen-xl">
      <div class="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
        <br>
        <br>
        <script src="https://unpkg.com/@dotlottie/player-component@latest/dist/dotlottie-player.mjs" type="module"></script>
         <div class="bg-gradient-to-r lg:bg-gradient-to-b bg-transparent lg:from-blue-700 lg:to-blue-500" style="padding: 10px; margin-left: 10px; border-radius: 10px;">
          <dotlottie-player src="https://lottie.host/9d173aac-b801-4baf-9123-6c6d92f61074/JB6N2gudfp.json"
                background="transparent" speed="1"
                style="width: 250px; height: 250px; margin: 0 auto;"
                loop autoplay>
          </dotlottie-player>
          <h2 class="text-2xl lg:font-black font-black text-black tracking-tight lg:text-white sm:text-4xl mb-2">
            GALLERY
          </h2>
    ...
    <br>
        ...
        <div class="sponsor container lg:p-[60px] p-4 lg:max-w-screen-xl">
            <div class=" flex flex-col justify-center items-center">
                <h1 class="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900">Organizer & Supporter Sukabumi <span class="text-blue-500">Robotik Competition</span></h1>
            ...
            <div class=" flex flex-col justify-center items-center">
                <h1 class="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900">Media Partner Sukabumi <span class="text-blue-500">Robotik Competition</span></h1>
                   <div class="grup py-5 flex flex-wrap gap-4 justify-center lg:justify-start">
            ...
            <div class=" flex flex-col justify-center items-center">
                <h1 class="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900">Sponsor Sukabumi <span class="text-blue-500">Robotik Competition</span></h1>
                
                 <div class="grup py-5 flex flex-wrap gap-4 justify-center lg:justify-start">
        @foreach ($sponsor as $sponsores)
            <div class="flex items-center justify-center p-2 border border-gray-200">
                <img class="lg:w-[200px] w-28" src="{{ $sponsores->image }}" alt="Logo {{ $sponsores->name }}">
            </div>
        @endforeach
    </div>
            </div>
 ...
 <div class="content-respasi-hotel py-3 px-2">
        <div class="body flex flex-col  justify-center items-center">
            <button
                ...
                Hotel</button>
            <br>
            <h1 class="font-medium text-center">( Hanya Take Kamar, Untuk Pemesanan dan Pembayaran hubungi nomor ini <span><a
                        href="https://wa.link/qavgnl" class="text-blue-400">0877 7292 1119</a></span> ) </h1>
        </div>
    </div>
    <div  id="lokasi" class="teknis relative w-full h-96 ">
        <div class="text absolute inset-0 m-5  py-38  lg:py-0 flex flex-col lg:items-center justify-center  lg:bottom-15 z-10">
            ...
            <p class="text-white text-[10px] lg:text-[15px]">Jl. Raya Cibolang Cisaat - Sukabhumi No.21, Cibolang Kaler, Kec. Cisaat, Kabupaten Sukabumi, Jawa Barat 43152</p>
            <div class="lg:py-4 py-3">
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15843.505268770257!2d106.8736239!3d-6.9053905!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6836505836821d%3A0x619b6e8271f232cc!2sNusa%20Putra%20University!5e0!3m2!1sid!2sid!4v1717400790980!5m2!1sid!2sid" class="w-full lg:w-[50em] rounded-2xl h-auto "  style="border:0;" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
