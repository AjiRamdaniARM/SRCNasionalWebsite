    ...
    <div class="flex items-center gap-10">
        ...
        <ul class="hidden lg:flex justify-center items-center font-medium gap-14 inter text-[17px] text-black">
            <li><a style="text-decoration:none"
                    class="page-scroll hover:text-[#F07602]  hover:font-bold {{ request()->routeIs('dashboard') ? ' text-[#F07602]  font-bold px-3 rounded-sm ' : '' }}"
                    href="{{ route('dashboard') }}">Dashboard</a></li>
            @role('admin')
                <li><a class="page-scroll hover:text-[#F07602] hover:font-bold
                        {{ request()->routeIs('invoice.index') ? ' text-[#F07602]  font-bold px-3 rounded-sm ' : '' }}"
                ...
                <li><a class="page-scroll hover:text-[#F07602] hover:font-bold
                    {{ request()->routeIs('organized.index') ? ' text-[#F07602]  font-bold px-3 rounded-sm ' : '' }}"
                        style="text-decoration: none" href="{{ route('organized.index') }}"
                        href="{{ route('organized.index') }}">Organize</a></li>
                <li><a class="page-scroll hover:text-[#F07602] hover:font-bold
                    {{ request()->routeIs('participant.show.admin') ? ' text-[#F07602]  font-bold px-3 rounded-sm ' : '' }}"
                        style="text-decoration: none" href="{{ route('participant.show.admin') }}">Participants</a></li>
                <li><a style="text-decoration:none"
                        class="page-scroll hover:text-[#F07602] hover:font-bold
                    {{ request()->routeIs('jadwalJD.index') ? ' text-[#F07602]  font-bold px-3 rounded-sm ' : '' }}"
                        href="{{ route('jadwalJD.index') }}">Jadwal</a></li>
                <li><a class="page-scroll hover:text-[#F07602] hover:font-bold
                    {{ request()->routeIs('race.index') ? ' text-[#F07602]  font-bold px-3 rounded-sm ' : '' }}"
                        style="text-decoration: none" href="{{ route('race.index') }}">Perlombaan</a></li>
            @endrole
            @role('participant')
                <li><a style="text-decoration:none"
                        class="page-scroll hover:text-[#F07602] hover:font-bold
                        {{ request()->routeIs('participant.invoice.index') ? ' text-[#F07602]  font-bold px-3 rounded-sm ' : '' }}"
                        href="{{ route('participant.invoice.index') }}">Invoice</a></li>
                <li><a style="text-decoration:none"
                        class="page-scroll hover:text-[#F07602] hover:font-bold
                        {{ request()->routeIs('participant.show.index') ? ' text-[#F07602]  font-bold px-3 rounded-sm ' : '' }}"
                        href="{{ route('participant.show.index') }}">Participant</a></li>
                <li><a style="text-decoration:none"
                        class="page-scroll hover:text-[#F07602] hover:font-bold
                    {{ request()->routeIs('participant.race.index') ? ' text-[#F07602]  font-bold px-3 rounded-sm ' : '' }}"
                        href="{{ route('participant.race.index') }}">Perlombaan</a>
                </li>
                <li><a style="text-decoration:none"
                        class="page-scroll hover:text-[#F07602] hover:font-bold
                    {{ request()->routeIs('jadwal') ? ' text-[#F07602]  font-bold px-3 rounded-sm ' : '' }}"
                    ...
                    <a href="{{ url('certificate') }}" class="flex flex-col gap-2 justify-center items-center">
                        ...
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <g>
                                ...
                                <path fill="#1C274C"
                                    d="M5,23c-0.276,0-0.5,0.224-0.5,0.5v6.946c0,0.571,0.324,1.088,0.86,1.35
