<x-home.app>
 ...
 Design-Webfont/5.3.45/css/materialdesignicons.min.css);
    ...
    <div class="w-full ">
        <div class="relative mt-36  py-10  px-10">
            <div class="grup flex flex-wrap justify-center items-center gap-5">
                <div class="sub-grup-text">
                    <h1 style="line-height:60px" class="inter font-bold lg:w-[600px] text-[3em] text-black lg:text-[4em]">
                        Bogor
                        Robotik <span class="text-blue-500">Competition</span></h1>
        ...
        <div class="container py-10">
            <div style=" border: 2px solid rgb(0, 85, 255);"
                ...
                <div class="md:flex items-center -mx-10">
                    ...
                    <div class="w-full md:w-1/2 px-10">
                        <div class="mb-10">
                            ...
                            <p>Pingin lihat deskripsi dari lomba {{ $data->name }} . silahkan untuk klik tombol ini
                                <button data-modal-target="static-modal" data-modal-toggle="static-modal"
                                    class="font-bold text-blue-500" type="button">DESKRIPSI</button>
                            </p>
                                ...
                                <div class="relative p-4 w-full max-w-2xl max-h-full">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow">
                                        ...
                                        <div
                                            ...
                                            <button type="button"
                                                class="text-gray-400 bg-transparent   rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center bg-gray-600 hover:text-white"
                                        ...
                                        <div class="flex items-center p-4 md:p-5 border-t border-gray-600">
                                            <button data-modal-hide="static-modal" type="button"
                                                class="py-2.5 px-5 ms-3 text-sm font-medium text-white focus:outline-none bg-blue-500 rounded-lg border border-gray-200 hover:bg-blue-800 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 ">Keluar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="inline-block align-bottom mr-5">
                                ...
                                <span
                                    class="font-bold text-2xl lg:text-5xl leading-none align-baseline">{{ number_format($data->price, 2, ',', '.') }}</span>
                            </div>
                            ...
                            <div class="inline-block align-bottom py-3">
                                ...
                                @if ($data->category->name == 'online')
                                    <button style="text-decoration: none" type="submit"
                                        onclick="window.dialogOnline.showModal();"
                                        class="bg-yellow-300 opacity-75 hover:opacity-100 text-yellow-900 hover:text-gray-900 rounded-full px-10 py-2 font-semibold"><i
                                            class="mdi mdi-cart -ml-2 mr-2"></i> Free Pendaftaran Lomba</button>
                                    {{-- modal bayar online --}}
                                    <dialog id="dialogOnline">
                                        <form action="{{ url('detail/online/' . $data->id) }}" id="myForm"
                                            method="POST">
                                            @csrf
                                            <h2 class="poppins-bold">Keranjang</h2>
                                            <div style="border: 2px solid #0080ff"
                                                class="block bg-white shadow-md rounded-2xl px-10 py-3 ">
                                                <h1 class="poppins-semibold text-start">{{ $data->name }} online
                                                    <span>
                                                        @if ($data->team == '0')
                                                            <h1>(Individu)</h1>
                                                        @else
                                            ...
                                            <div class="block p-5 bg-blue-300 rounded-2xl relative mt-4">
                                                ...
                                                <input type="number" name="jumlah" class="relative mt-2 rounded-xl"
                                                    required>
                                            </div>
                                            <div style="border: 2px solid #b2b2b2"
                                                class="block bg-white relative mt-4 rounded-xl px-4 py-3 ">
                                            ...
                                            <input type="text" id="id_race" name="races"
                                        ...
                                        <button onclick="window.dialogOffline.close();" aria-label="close"
                                            class="x">❌</button>
                                    </dialog>
                                @else
                                    <button style="text-decoration: none" type="submit"
                                        ...
                                        class="bg-yellow-300 opacity-75 hover:opacity-100 text-yellow-900 hover:text-gray-900 rounded-full px-10 py-2 font-semibold"><i
                                            class="mdi mdi-cart -ml-2 mr-2"></i> Checkout Sekarang</button>
                                    {{-- modal bayar offline --}}
                                    <dialog id="dialog">
                                        <form action="{{ url('detail/' . $data->id) }}" id="myForm"
                                            method="POST">
                                            @csrf
                                            <h2 class="poppins-bold">Keranjang</h2>
                                            <div style="border: 2px solid #0080ff"
                                            ...
                                            <div class="block p-5 bg-blue-300 rounded-2xl relative mt-4">
                                                ...
                                                <input type="number" id="jumlah" name="jumlah"
                                                    class="relative mt-2 rounded-xl" required>
                                            </div>
                                            <div style="border: 2px solid #b2b2b2"
                                                class="block bg-white relative mt-4 rounded-xl px-4 py-3 ">
                                                <div class="flex justify-between items-center">
                                                    <h1 class="poppins-semibold">Harga</h1>
                                                    <div class="poppins-semibold" id="price">{{ $data->price }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="block bg-white relative mt-4 rounded-xl px-4 py-3 ">
