            ...
            <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="card-body">
                    <div class="flex flex-col justify-center items-center ">
                        <img src="assets/logo-src.png" alt="SRC Logo" class="img-profile mb-3 w-80 ">
                    ...
                    <form action="{{ url('/register') }}" class="user" method="POST">
                        ...
                        <div class="row row-cols-1 row-cols-sm-2">
                            <div class="col">
                                <x-forms.input name="community" label="School/Team" required="true"
                                    help="Enter school or team name" />
                            </div>
                            <div class="col">
                        ...
                        <div class="row row-cols-1 row-cols-sm-2">
                                ...
                                <div class="password-wrapper">
                                    ...
                                    <div class="input-container">
                                        <input id="password" name="password" required="true" type="password"
                                            ...
                                            class="py-1 px-2 rounded-lg border-2 border-gray-200" required
                            ...
                            <div class="col">
                                <div class="password-wrapper">
                                    ...
                                    <div class="input-container">
                                        <input id="confirm_password" name="password_confirmation" required="true"
                                            type="password" aria-describedby="confirmPasswordHelp"
                                            class="py-1 px-2 rounded-lg border-2 border-gray-200" required
                                            placeholder="Confirm New Password" />
                                        <span class="toggle-password" data-target="confirm_password">👁️</span>
                                    </div>
                                    <small id="confirmPasswordHelp" class="form-text text-muted">Min 8
                                        characters</small>
                                </div>
                                <script>
