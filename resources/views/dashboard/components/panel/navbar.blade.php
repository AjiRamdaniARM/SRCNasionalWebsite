<nav class="navbar justify-around bg-white items-center  top-0 left-0 right-0 z-50 p-3 shadow-md ">
    <div class="flex items-center gap-10">
        ...
        <ul class="hidden lg:flex justify-center items-center font-medium gap-14 inter text-[17px] text-black">
            <li><a style="text-decoration:none" class="page-scroll  hover:font-bold {{ request()->routeIs('dashboard') ? 'bg-blue-500 text-white px-3 rounded-sm ' : '' }}" href="{{ route('dashboard') }}">Dashboard</a></li>
            @role('admin')
            <li><a class="{{ request()->routeIs('invoice.index') ? 'bg-blue-500 text-white px-3 rounded-sm ' : '' }}"  style="text-decoration: none" href="{{ route('invoice.index') }}">Invoice</a></li>
             <div class="relative">
                <button id="dropdownButton" class="px-4 py-2"> Directive & Faqs </button>
                {{-- dropdownmenu --}}
                <ul id="dropdownMenu" class="absolute hidden mt-2 bg-white border border-gray-200 rounded shadow-lg w-48">
                    <li>
                        <a href="{{ route('directive.index') }}" class="{{ request()->routeIs('directive.index') ? 'bg-blue-500 text-white px-3 rounded-sm transition-all' : '' }} block px-4 py-2  hover:bg-gray-200">
                            Directive
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('faq.index') }}" class="block px-4 py-2  hover:bg-gray-200 {{ request()->routeIs('faq.index') ? 'bg-blue-500 text-white px-3 rounded-sm transition-all' : '' }}">
                            FAQs
                        </a>
                    </li>
                </ul>
            ...
            <li><a class="{{ request()->routeIs('organized.index') ? 'bg-blue-500 text-white px-3 rounded-sm' : '' }}"  style="text-decoration: none" href="{{ route('organized.index') }}">Organize</a></li>
            <li><a class="{{ request()->routeIs('participant.show.admin') ? 'bg-blue-500 text-white px-3 rounded-sm' : '' }}"  style="text-decoration: none" href="{{ route('participant.show.admin') }}">Participants</a></li>
            <li><a class="{{ request()->routeIs('race.index') ? 'bg-blue-500 text-white px-3 rounded-sm' : '' }}"  style="text-decoration: none" href="{{ route('race.index') }}">Perlombaan</a></li>
            @endrole
            @role('participant')
            <li><a style="text-decoration:none" class="page-scroll hover:font-bold" href="{{ route('participant.invoice.index') }}">Invoice</a></li>
            <li><a style="text-decoration:none" class="page-scroll hover:font-bold" href="{{ route('participant.show.index') }}">Participant</a></li>
            <li><a style="text-decoration:none" class="page-scroll hover:font-bold" href="{{ route('participant.race.index') }}">Perlombaan</a></li>
            <li><a style="text-decoration:none" class="page-scroll hover:font-bold" href="{{ url('jadwal') }}">Jadwal</a></li>
            <li><a style="text-decoration:none" class="page-scroll hover:font-bold" href="{{ url('/certificate') }}">Sertifikate</a></li>
            @endrole
        </ul>
    </div>
    <div class="relative flex items-center gap-4">
        ...
        <ul class="navbar-nav lg:block hidden ">
                    <li>
                        <button id="dropdownInformationButton" data-dropdown-toggle="dropdownInformation" class="text-blue-500 font-bold bg-white border rounded-full text-sm px-4 py-2.5 text-center inline-flex items-center " type="button"> Hello, {{ auth()->user()->name }} <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
...
<div id="modal-nav-bg"  class="absolute  lg:hidden hidden bg-modal-nav -top-10 bg-black/40  w-full h-full z-50"></div>
        <div id="modal-nav" class="lg:hidden hidden slide-top  fixed inset-x-0 bottom-0 h-[40em] rounded-t-[50px] z-50  bg-white shadow-md">
            ...
            <div class="flex justify-around items-center py-2">
                <ul class="lg:hidden relative -bottom-10 grid grid-cols-2 gap-4 md:grid-cols-4  font-medium  inter text-[17px] text-black">
                    <li class=" bg-white border-black flex flex-col justify-start items-center  rounded-lg text-black py-2"><a class="flex flex-col justify-center items-center" href="{{ url('dashboard') }}">
                        <?xml version="1.0" encoding="utf-8"?>
                ...
                @role('admin')
                 <li class=" bg-white border-black flex flex-col justify-start items-center  rounded-lg text-black py-2"><a class="flex flex-col justify-center items-center" href="{{ route('invoice.index') }}">
                        <?xml version="1.0" encoding="utf-8"?><!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
                        <svg width="60px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M14 14H17M14 10H17M9 9.5V8.5M9 9.5H11.0001M9 9.5C7.20116 9.49996 7.00185 9.93222 7.0001 10.8325C6.99834 11.7328 7.00009 12 9.00009 12C11.0001 12 11.0001 12.2055 11.0001 13.1667C11.0001 13.889 11.0001 14.5 9.00009 14.5M9.00009 14.5L9 15.5M9.00009 14.5H7.0001M6.2 19H17.8C18.9201 19 19.4802 19 19.908 18.782C20.2843 18.5903 20.5903 18.2843 20.782 17.908C21 17.4802 21 16.9201 21 15.8V8.2C21 7.0799 21 6.51984 20.782 6.09202C20.5903 5.71569 20.2843 5.40973 19.908 5.21799C19.4802 5 18.9201 5 17.8 5H6.2C5.0799 5 4.51984 5 4.09202 5.21799C3.71569 5.40973 3.40973 5.71569 3.21799 6.09202C3 6.51984 3 7.07989 3 8.2V15.8C3 16.9201 3 17.4802 3.21799 17.908C3.40973 18.2843 3.71569 18.5903 4.09202 18.782C4.51984 19 5.07989 19 6.2 19Z" stroke="#1C274C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        Inovice</a>
                    </li>
                    <li class=" bg-white border-black flex flex-col justify-start items-center  rounded-lg text-black py-2"><a class="flex flex-col justify-center items-center" href="{{ route('directive.index') }}">
                        <svg width="60px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 18V12M12 12L14 14M12 12L10 14M13 3H8.2C7.0799 3 6.51984 3 6.09202 3.21799C5.71569 3.40973 5.40973 3.71569 5.21799 4.09202C5 4.51984 5 5.0799 5 6.2V17.8C5 18.9201 5 19.4802 5.21799 19.908C5.40973 20.2843 5.71569 20.5903 6.09202 20.782C6.51984 21 7.0799 21 8.2 21H15.8C16.9201 21 17.4802 21 17.908 20.782C18.2843 20.5903 18.5903 20.2843 18.782 19.908C19 19.4802 19 18.9201 19 17.8V9M13 3L19 9M13 3V7.4C13 7.96005 13 8.24008 13.109 8.45399C13.2049 8.64215 13.3578 8.79513 13.546 8.89101C13.7599 9 14.0399 9 14.6 9H19" stroke="#1C274C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        Directive</a>
                    </li>
                    <li class=" bg-white border-black flex flex-col justify-start items-center  rounded-lg text-black py-2"><a class="flex flex-col justify-center items-center" href="{{ route('organized.index') }}">
                    <svg version="1.1" id="Uploaded to svgrepo.com" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        width="60px"  viewBox="0 0 32 32" xml:space="preserve">
                    <style type="text/css">
                        .feather_een{fill:#1C274Cx;}
                    </style>
                ...
                @endrole
                    ...
                    <li class=" bg-white border-black   rounded-lg text-black py-2">
                        <a href="{{ route('participant.invoice.index') }}" class="flex flex-col gap-2 justify-center items-center">
                            <?xml version="1.0" encoding="utf-8"?><!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
                    ...
                    <li class=" bg-white border-black   rounded-lg text-black py-2">
                        <a href="{{ route('participant.show.index') }}" class="flex flex-col gap-2 justify-center items-center">
                           <img width="60px" src="{{asset('assets/people-grup.svg')}}" alt="">
                        Participants
                    </a>
                    </li>
                    ...
                    <li class=" bg-white border-black   rounded-lg text-black py-2">
                        ...
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            width="45px"  viewBox="0 0 23 32" enable-background="new 0 0 23 32" xml:space="preserve">
                        <g>
                            <path fill="#1C274C" d="M11.5,4.727c-3.584,0-6.5,2.916-6.5,6.5s2.916,6.5,6.5,6.5s6.5-2.916,6.5-6.5S15.084,4.727,11.5,4.727z
                                M11.5,16.727c-3.032,0-5.5-2.467-5.5-5.5s2.468-5.5,5.5-5.5s5.5,2.467,5.5,5.5S14.532,16.727,11.5,16.727z"/>
                            <path fill="#1C274C" d="M21.617,7.226c0.22-0.921,0.116-1.727-0.306-2.349c-0.419-0.617-1.121-1.008-2.045-1.145
                            ...
                            <path fill="#1C274C" d="M14.297,8.355l-3.458,4.598l-2.15-2.206c-0.194-0.198-0.511-0.201-0.707-0.009
