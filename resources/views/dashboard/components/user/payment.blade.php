        ...
        <div class="relative rounded-md">
            <div class="flex shadow-md">
                ...
                <div class="group flex justify-center items-center gap-2">
                    <input type="text" name="name[]" id="website-admin" class="rounded-none rounded-e-lg bg-gray-50 border text-black focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5" placeholder="Nama Peserta {{ $i + 1 }} " required>
                    <input type="text" name="kelas[]" id="website-admin" class="rounded-none rounded-e-lg bg-gray-50 border text-black focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5" placeholder="Kelas Peserta {{ $i + 1 }} "required >
